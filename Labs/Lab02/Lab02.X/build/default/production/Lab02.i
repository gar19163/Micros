...
; Palabra de configuración 1
  ...
  CONFIG FOSC = XT ; Oscillator Selection bits (RC oscillator: CLKOUT function on ((PORTA) and 07Fh), 6/OSC2/CLKOUT pin, RC on ((PORTA) and 07Fh), 7/OSC1/CLKIN)
...
main:
    ...
    ;movlw 11111000B ;Declaramos el puerto C para ser de 4 bits de salida
    clrf TRISB
