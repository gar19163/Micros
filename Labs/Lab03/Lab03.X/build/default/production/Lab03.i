...
main:
    ...
    bsf TRISB, 2
    clrf TRISB ;Salida pines del puerto B Leds
...
config_clock:
    ...
    bcf ((OSCCON) and 07Fh), 6 ;Trabaja 250kHz (010)
...
config_tmr0:
    ...
    bcf ((OPTION_REG) and 07Fh), 3 ;Preescalares
    bsf ((OPTION_REG) and 07Fh), 2 ;111
...
cont_1:
    btfss ((INTCON) and 07Fh), 2 ;Contador en puerto B
    goto $-1 ;
