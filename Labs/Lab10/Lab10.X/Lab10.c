...
//  arreglos
//-------------------------------------------------------
char men []  ="Que accion desas ejecutar? \r";
char op1 []  ="(1) Desplegar caracteres \r";
char op2 []  ="(2) Cambiar PORTA \r";
char op3 []  ="(3) Cambiar PORTB \r";
char pa1 []  ="Hola mundo, que tal? \r";
char pa  []  ="Seleciones nuevo careacter \r";
//-------------------------------------------------------
//   Prototipo
//------------------------------------------------------
void setup(void);
    ...
    while (1) {                         //Loop
        ...
        switch(op){                      //Opciones
            ...
            case ('3'):
                send_str(pa);
                while(PIR1bits.RCIF == 0);//Reviso bandera
                PORTB = caracter;         //Muestro variable en PORTA
                __delay_ms(1000);         //Delay para limpiar
                TXREG = '\f';             //Limpio
