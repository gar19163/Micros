...
isr:
    ...
    btfsc ((INTCON) and 07Fh), 2 ;Revisar bandera
    call int_T ;interrup
...
int_T:
    reset_tmr0 ;Resetear el timer0
    clrf PORTD ;Limpiar el puerto D
    btfss bandera, 0 ;Saltar la instrucción si la bandera esta en 1
...
main:
    ...
    call config_clock ;Llamamos las configuraciones
    call config_int_ena
    call onfig_int_oc
    call config_tmr0
    banksel PORTA
...
config_clock:
    ...
    bsf ((OSCCON) and 07Fh), 6 ;Trabaja 4MHz (110)
...
config_int_ena:
    ...
    bcf ((INTCON) and 07Fh), 2
    bsf ((INTCON) and 07Fh), 3 ;habilito bandera
    bcf ((INTCON) and 07Fh), 0 ;cambio bandera
    return
...
config_tmr0:
    ...
    bcf ((OPTION_REG) and 07Fh), 3 ;preescalar(111)
    bsf ((OPTION_REG) and 07Fh), 2
    bsf ((OPTION_REG) and 07Fh), 1
    bsf ((OPTION_REG) and 07Fh), 0 ;PS 256
