    ...
    while (1) {
        ...
        switch(op){
            case ('1'):
                TRISA = 0x00;
                TXREG = '\f';
                send_str("Girando pierna Izq a 0");
            ...
            case ('2'):
                TRISA = 0x00;
                TXREG = '\f';
                send_str("Girando pierna Izq a 90");
                _delay((unsigned long)((3000)*(8000000/4000.0)));
                TXREG = '\f';
                servo1Rotate90();
                ban = 1;
            ...
            case ('4'):
                TRISA = 0x00;
                TXREG = '\f';
                send_str("Girando pier Izq a 90");
                _delay((unsigned long)((3000)*(8000000/4000.0)));
                TXREG = '\f';
                servo2Rotate90();
                ban = 1;
            ...
            case ('5'):
                TRISA = 0x00;
                TXREG = '\f';
                send_str("Girando pierna der a 0");
                _delay((unsigned long)((3000)*(8000000/4000.0)));
                TXREG = '\f';
                servo3Rotate0();
                ban = 1;
            ...
            case ('6'):
                TRISA = 0x00;
                TXREG = '\f';
                send_str("Girando pierna der a 90");
                _delay((unsigned long)((3000)*(8000000/4000.0)));
                TXREG = '\f';
                servo3Rotate90();
                ban = 1;
            ...
            case ('8'):
                TRISA = 0x00;
                TXREG = '\f';
                send_str("Girando pier der a 90");
                _delay((unsigned long)((3000)*(8000000/4000.0)));
                TXREG = '\f';
                servo4Rotate90();
                ban = 1;
